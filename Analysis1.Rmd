...
```
We can also build a url with site.02105900.floyd.discharge. Note that the discharges are denoted with a qualcode. Qualcode "A" denotes approved for publication, qualcode "e" means that the value has been edited or estimated be USGS personnel. A full list of qualcodes is available at (http://help.waterdata.usgs.gov/codes-and-parameters/daily-value-qualification-code-dv_rmk_cd)
...
site.02105900.percentile.data <- c(681, 327, 182, 208, 233, 824, 357, 190, 241, 196, 288, 740, 425, 296, 839, 983, 757, 518, 504, 337, 299, 297, 634, 640, 377, 287)
