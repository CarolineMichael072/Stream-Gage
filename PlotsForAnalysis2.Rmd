...
plot(site.02087324.floyd.discharge, type="o", col="blue", ylim=c(0,6500))
...
plot(site.02085070.floyd.discharge, type="o", col="blue", ylim=c(0,5500))
...
site.02144000.p50.data <- xtable(site.02144000.p50.data[245:270, ])$p50_va
...
site.02145000.p95.data <- xtable(site.02145000.p95.data[245:270, ])$p95_va
...
site.02145000.p50.data <- xtable(site.02145000.p50.data[245:270, ])$p50_va
...
plot(site.0212414900.floyd.discharge, type="o", col="blue")
...
plot(site.02047000.floyd.discharge, type="o", col="blue")
